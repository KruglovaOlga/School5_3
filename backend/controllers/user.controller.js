...
// Get a user by ID
//(GET)http://localhost:3000/api/user/getById/6450b9735da248f5e9a3091b  OK
...
// http://localhost:3000/api/user/getByUsername/student012  OK
...
//http://localhost:3000/api/user/create  OK
...
//http://localhost:3000/api/user/update/teacher10  OK
exports.update = async (req, res) => {
  ...
  try {
    ...
    console.log(`Error in updating user with username ${username}`, err);
  }
};

// Delete a user by ID
//http://localhost:3000/api/user/deleteById/6480d5a0eba340adc698fca2
...
//(DELETE)http://localhost:3000/api/user/deleteByUsername/student0155  OK
...
//Returns User Id for using in other functions    OK
